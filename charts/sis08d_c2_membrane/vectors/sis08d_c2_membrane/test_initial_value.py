"""SOS-09-F emitted vectors — family=initial_value.
...
from vectors.families.initial_value import vector_class
...
def _load_plans():
    ...
    plans = []
    for p in raw["plans"]:
        if "initial_value" not in p["families"]:
            continue
...
def test_initial_value(plan):
    """Exercise the initial_value vector for each annotated channel."""
