"""SOS-09-F emitted vectors — family=protection.
...
from vectors.families.protection import vector_class
...
def _load_plans():
    ...
    plans = []
    for p in raw["plans"]:
        if "protection" not in p["families"]:
            continue
...
def test_protection(plan):
    """Exercise the protection vector for each annotated channel."""
