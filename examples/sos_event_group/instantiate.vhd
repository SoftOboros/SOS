-- =============================================================================
-- instantiate.vhd  --  sos_event_group instantiation example (N_BITS=32)
--
...
-- example exercises the default directly via a `generic map`; charts wanting
-- a smaller event group instantiate sos_event_group with N_BITS => K.
--
...
entity sos_event_group_example is
    port (
        clk        : in  std_logic;
        rst        : in  std_logic;
        set_req    : in  std_logic;
        set_mask   : in  std_logic_vector(31 downto 0);
        clear_req  : in  std_logic;
        clear_mask : in  std_logic_vector(31 downto 0);
        wait_mask  : in  std_logic_vector(31 downto 0);
        wait_mode  : in  std_logic;
        wait_match : out std_logic;
        bits       : out std_logic_vector(31 downto 0)
    );
end entity sos_event_group_example;

architecture rtl of sos_event_group_example is
begin

    u_event_group : entity work.sos_event_group
        generic map (
            N_BITS => 32
        )
        port map (
